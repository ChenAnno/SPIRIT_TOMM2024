...
def extract_index_features(dataset, clip_model) -> Tuple[torch.tensor, List[str], torch.tensor]:
    """
    ...
    index_names = []
    index_local_features = torch.empty((0, 13, 640)).to(device, non_blocking=True)
    ...
    return index_features, index_names, index_local_features
